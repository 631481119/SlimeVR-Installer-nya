...
Section "SlimeVR Server" SEC_SERVER
    ...
    NScurl::http GET "https://gitee.com/unshakenxu/slime-vr-server-nya/releases/download/0.12.5/SlimeVR-win64.zip" "${SLIMETEMP}\SlimeVR-win64.zip" /CANCEL /RESUME /END
