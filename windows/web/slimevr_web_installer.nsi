...
Section "SlimeVR Server" SEC_SERVER
    ...
    NScurl::http GET "https://github.com/631481119/SlimeVR-Server-nya/releases/download/v0.12.5/SlimeVR-win64.zip" "${SLIMETEMP}\SlimeVR-win64.zip" /CANCEL /RESUME /END
