...
Section "SlimeVR Server" SEC_SERVER
    ...
    NScurl::http GET "https://gitee.com/unshakenxu/slime-vr-server-nya/releases/download/nya_v0.13.2/SlimeVR-win64.zip" "${SLIMETEMP}\SlimeVR-win64.zip" /CANCEL /RESUME /END
...
Section "SlimeVR Feeder App" SEC_FEEDER_APP
    ...
    NScurl::http GET "https://gitee.com/unshakenxu/slime-vr-server-nya/releases/download/Feeder/SlimeVR-Feeder-App-win64.zip" "${SLIMETEMP}\SlimeVR-Feeder-App-win64.zip" /CANCEL /RESUME /END
    Pop $0 ; Status text ("OK" for success)
    ${If} $0 != "OK"
